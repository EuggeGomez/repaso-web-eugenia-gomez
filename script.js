...
const originalSrc = 'imagenes/euge1.png';
const gifSrc = 'imagenes/seeyou.gif';

if (profileImage) {
    profileImage.addEventListener('click', function () {
        // Switch to gif
        this.src = gifSrc;
        this.style.transition = 'transform 0.4s cubic-bezier(0.36, 0.07, 0.19, 0.97)';
        ...
        // Switch back to original photo after 2 seconds
        setTimeout(() => {
